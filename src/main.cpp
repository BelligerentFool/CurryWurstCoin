...
uint256 hashGenesisBlock("0x05b02f8f14103d91659c86b9aa069a27de927322034548ee351bc0966aad6c78");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // CurryWurstCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "CurryWurstCoin Signed Message:\n";
...
{
    // CurryWurstCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 5900000000;

    // Subsidy is cut in half every 300,613 blocks, which will occur approximately every 208 days
    nSubsidy >>= (nHeight / 300613); // CurryWurstCoin: 300,613 blocks in ~208 days

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 360; // CurryWurstCoin: 6 minutes
static const int64 nTargetSpacing = 60; // CurryWurstCoin: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // CurryWurstCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // CurryWurstCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // CurryWurstCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x376f96644572903b774903cba69c242f1ec691fcee32e9c652899028567102df");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].nValue = 5900000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("628353ff371234bc1e4a0f8c3b8604b5a98fbc160293b37f1c15ac9807210f0108b0863d0ba411d166df145af3a1125122b7da1bf936904dd15e64642ae4c7e6b2") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1471923679;
        block.nBits    = 537261531;
        block.nNonce   = 685695486;

        if (fTestNet)
        {
            block.nTime    = 1471923679;
            block.nNonce   = 591863937;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x19f56c098fced310967866a00e5c140db77683131f044ec07ed3d9e85d04a5c3"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // CurryWurstCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("CurryWurstCoin RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CurryWurstCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CurryWurstCoinMiner : ProcessBlock, block not accepted");
    }
